...
class Cliente(models.Model):
    ...
    usuario = models.OneToOneField(User, null=True, blank=True, on_delete=models.CASCADE) #relacionamento cliente - usuário (1 para 1)
