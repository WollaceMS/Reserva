...
Implementação de arquitetura MVC (MTV no Django)

Criação de páginas dinâmicas com templates
...
Este projeto foi desenvolvido exclusivamente para fins educacionais e de portfólio, sem qualquer vínculo comercial com a marca original.
